...
const DATA = [
  { id: "1", title: "", icon: require("../assets/img/bitcoin.png") },
  {
    id: "2",
    title: "Crowd lending",
    icon: require("../assets/img/crowd_landing.png"),
  },
  {
    id: "3",
    title: "Crowd real estate",
    icon: require("../assets/img/crowd_real_estate.png"),
  },
  {
    id: "4",
    title: "Commodities",
    icon: require("../assets/img/commodities.png"),
  },
...
export default function WelcomeScreen({ navigation }) {
  const renderItem = ({ item, index }) => {
    ...
    const columnStyle =
      index % 2 === 1 && item.id === "1" ? styles.secondColumn : {};
    return (
      <Card
        title={item.title}
        icon={item.icon}
        style={[cardStyle, columnStyle]}
        iconStyle={iconStyle}
      />
    );
  };
